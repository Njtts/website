                ...
                div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-10" {
                    ...
                    div class="lg:col-span-2 space-y-8 sm:space-y-0" {
                        ...
                        div id="2024" class="space-y-4" {
                            ...
                            // Event 1
                            div class="space-y-4" {
                                h3 class="text-xl font-semibold text-gray-800" {"Event 1 Title"}
                                a href="https://drive.google.com/drive/folders/1-AxW5HoyMlpYtwTk3SNb_NmHjSAsShzz"

                                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4 border rounded-lg shadow-lg bg-white" {
                                    // Image 1
                                    div class="group relative" {

                                            img src="https://lh3.googleusercontent.com/drive-viewer/AKGpihalqTBP-9htcJ5jQUlw8VvzwNAlomVh6iAxx1pxnCVvi2XYiSLRhJvTPqsZqmEIwu3MdU3IyJbg-kQhn9Fb6u4sCCvsgpvxsVE=s1600-rw-v1" alt="Photo 1" class="rounded-lg object-cover w-full h-full transform transition-transform duration-300 group-hover:scale-105";
